...
public class TabComponent extends JPanel {
	...
	public TabComponent(JTabbedPane tabbedPane, String title) {
		...
		setOpaque(false);
		setLayout(new FormLayout(new ColumnSpec[]{ColumnSpec.decode("55px"), ColumnSpec.decode("7px"), FormSpecs.DEFAULT_COLSPEC}, new RowSpec[]{RowSpec.decode("max(20px;default)")}));
